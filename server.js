...
const sampleSquads = {
    "Argentina": ["E Martinez", "L Martinez", "N Molina", "C Romero", "N Otamendi", "N Tagliafico", "R De Paul", "E Fernandez", "A Mac Allister", "L Messi", "J Alvarez"], "France": ["M Maignan", "D Upamecano", "I Konate", "T Hernandez", "J Kounde", "A Tchouameni", "A Rabiot", "A Griezmann", "K Mbappe", "O Giroud", "O Dembele"], "Brazil": ["Alisson B", "Marquinhos", "E Militao", "Danilo", "Alex Sandro", "Casemiro", "Lucas Paqueta", "Neymar Jr", "Vinicius Jr", "Rodrygo G", "Richarlison"], "England": ["J Pickford", "K Walker", "J Stones", "H Maguire", "L Shaw", "D Rice", "J Bellingham", "J Henderson", "B Saka", "H Kane", "P Foden"], "Portugal": ["D Costa", "Ruben Dias", "Pepe", "J Cancelo", "N Mendes", "J Palhinha", "B Fernandes", "B Silva", "R Leao", "C Ronaldo", "J Felix"], "Belgium": ["T Courtois", "T Castagne", "W Faes", "J Vertonghen", "A Theate", "A Onana", "Y Tielemans", "K De Bruyne", "J Doku", "R Lukaku", "L Trossard"], "Croatia": ["D Livakovic", "J Stanisic", "J Sutalo", "J Gvardiol", "B Sosa", "M Brozovic", "L Modric", "M Kovacic", "M Pasalic", "A Kramaric", "I Perisic"], "Netherlands": ["B Verbruggen", "D Dumfries", "S de Vrij", "V van Dijk", "N Ake", "T Reijnders", "J Schouten", "X Simons", "C Gakpo", "M Depay", "S Bergwijn"], "Italy": ["G Donnarumma", "G Di Lorenzo", "A Bastoni", "R Calafiori", "F Dimarco", "Jorginho", "N Barella", "D Frattesi", "F Chiesa", "G Scamacca", "L Pellegrini"], "Spain": ["U Simon", "D Carvajal", "R Le Normand", "A Laporte", "M Cucurella", "Rodri", "Pedri", "F Ruiz", "L Yamal", "A Morata", "N Williams"], "Germany": ["M Neuer", "J Kimmich", "A Rüdiger", "J Tah", "M Mittelstädt", "R Andrich", "T Kroos", "J Musiala", "I Gündogan", "F Wirtz", "K Havertz"],
};
